...
Each team memebr worker on their own branch:
this workflow helped the team collaboration to be effective while avoid merge conflicts
...
## Technoligies used
 - Bash Shell scritpting
 - Python3
 - Git/WSL/Webtern and GitHub
